...
namespace NotificationService.Messaging
{
    public class CommentMentionedConsumer: BackgroundService
    {
        ...
        public CommentMentionedConsumer(
            ILogger<CommentMentionedConsumer> logger,
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _logger.LogInformation("Waiting for CommentMentioned messages from queue: {QueueName}", QueueName);
            ...
            consumer.ReceivedAsync += async (_, ea) =>
            {
                try
                {
                    ...
                    var evt = JsonSerializer.Deserialize<CommentMentionedEvent>(message);
                ...
                {
                    _logger.LogError(ex, "Error processing CommentMentioned event");
