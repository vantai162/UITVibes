...
namespace NotificationService.Messaging
{
    public class UserFollowedConsumer: BackgroundService
    {
        ...
        public UserFollowedConsumer(ILogger<UserFollowedConsumer> logger, IServiceProvider serviceProvider)
        {
            _logger = logger;
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.ReceivedAsync += async (_, ea) =>
            {
                try
                {
                    ...
                    var evt = JsonSerializer.Deserialize<UserFollowedEvent>(message);
                    ...
                    if (evt != null)
                    {
                        ...
                        await notificationService.CreateAsync(
                            new NotificationInput(
                                ...
                                EntityId: evt.FollowerId,
                                Type: NotificationType.NewFollower,
                                ActorName: evt.FollowerName),
                            stoppingToken);
                ...
                {
                    _logger.LogError(ex, "Error processing UserFollowed event");
