...
export default function EmailVerificationScreen() {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (isFromLogin) {
        // ── Luồng 2: Login → Verify → Lấy token ngay ──
        const authData = await api.verifyEmailAndLogin(verifiedEmail, code);
        console.log("[Verify] verifyEmailAndLogin response:", {
        ...
        console.log("[Verify] Token saved. Navigating to onboarding.");
