/**
 * CommentContextMenu — bottom sheet triggered by long-press on a comment.
 *
 * UX spec:
 ...
 *  - Options: "Edit comment" · "Delete comment"
  ...
  return (
    <View style={styles.menu}>
      ...
      >
        ...
        <Text style={[styles.menuItemText, styles.deleteText]}>Delete comment</Text>
      </TouchableOpacity>
    </View>
  );
}
